# Das script findet ein Toolbox projekt und convertiert es nach bestimmten regeln zu einer CSV Datei um.
# die csv datei wird in einen definierten Ordner abgespeichert.
